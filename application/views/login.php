               ...
               <div class="col-sm-12">
                  <form class="md-float-material form-material" action="<?=base_url()?>login/loginprocess" method="post">
                     <div class="text-center">
                        <h3><img alt="Music App" src="<?=base_url()?>/assets/images/<?php echo $settings->app_logo?>"></h3>
                        <br>
                        <h3 class="text-center text-white" style="font-weight: 600;"><?php echo $settings->app_name?></h3>
                     </div>

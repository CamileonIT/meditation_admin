                                    ...
                                    <table id="footer-search" class="excel-bg table table-bordered nowrap">
                                       ...
                                       <tbody style="text-align: center;">
                                          ...
                                          <tr id="<?php echo  $i; ?>" style="line-height: 25px;">
                                             ...
                                             <td><a data-toggle="modal" data-target="#edit-payment" class="edit_pay" id="<?php echo $payment->payment_method_id.'|'.$payment->payment_method_name.'|'.$payment->payment_method_currency.'|'."".'|'.""?>" style="cursor: pointer;">

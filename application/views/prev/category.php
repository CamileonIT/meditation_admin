                                    ...
                                    <table id="footer-search" class="excel-bg table table-bordered nowrap">
                                       ...
                                       <tbody style="text-align: center;">
                                          ...
                                          <tr id="<?php echo  $i; ?>" style="line-height: 25px;">
                                             ...
                                             <td><a data-toggle="modal" data-target="#edit-category" class="edit_cat" id="<?php echo $cat->category_id.'|'.$cat->category_name.'|'.$cat->category_icon?>" style="cursor: pointer;">

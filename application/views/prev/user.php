                                       ...
                                       <tbody style="text-align: center;" id="invoice_api">
                                          ...
                                          <tr>
                                            ...
                                            <?php foreach($user->playlists as $playlist){?>     
                                                ...
                                                <!--<span class=""><?php echo $playlist->user_playlist_name .' ('.$playlist->playlist_music_count.')'; ?></span>-->
                                                </a>
                                                <br>
                                            <?php } ?>
                                            </td>
                                             <td><?php echo $user->package_name;?><br>
                                             <a href="<?=base_url()?>admin/userPayments/<?php echo $user->user_id; ?>" >

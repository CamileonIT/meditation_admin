                                    ...
                                    <table id="footer-search" class="excel-bg table table-bordered nowrap">
                                       ...
                                       <tbody style="text-align: center;" id="invoice_api">
                                          ...
                                          <tr>
                                             ...
                                             <td><a data-toggle="modal" data-target="#edit-settings" class="edit_settings" id="<?php echo $notification->notification_id.'|'.$notification->settings_name.'| ';?>" style="cursor: pointer;">
